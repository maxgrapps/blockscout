defmodule Explorer.Chain.OrderedCache do
  ...
  # credo:disable-for-next-line Credo.Check.Refactor.CyclomaticComplexity Credo.Check.Refactor.PerceivedComplexity
  defp do_using(name, opts) when is_atom(name) and is_list(opts) do
    ...
    quote do
      ...
      defp put_element(element_id, element) do
        ...
        ConCache.put(cache_name(), element_id, full_element)
      end
